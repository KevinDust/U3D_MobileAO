...
#define HBAO_DEFERRED_INCLUDED
    ...
    CombinerOutput frag(v2f i) {
		...
		float emission = saturate((o.gbuffer3.r + o.gbuffer3.g + o.gbuffer3.b) / 3);
		o.gbuffer3.rgb *= lerp(ao, float3(1.0, 1.0, 1.0), emission);
    ...
    CombinerOutput frag_blend(v2f i) {
		...
		float emission = saturate((rt3.x + rt3.y + rt3.z) / 3);
		o.gbuffer3 = half4(lerp(ao, float3(1.0, 1.0, 1.0), emission), 0);
